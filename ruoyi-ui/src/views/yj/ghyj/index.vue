  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="地区" prop="diqu">
          <el-input v-model="form.diqu" placeholder="请输入地区" />
        </el-form-item>
        <el-form-item label="气压" prop="qy">
          <el-input v-model="form.qy" placeholder="请输入气压" />
        </el-form-item>
        <el-form-item label="气温" prop="qw">
          <el-input v-model="form.qw" placeholder="请输入气温" />
        </el-form-item>
        <el-form-item label="最高气温" prop="maxqw">
          <el-input v-model="form.maxqw" placeholder="请输入最高气温" />
        </el-form-item>
        <el-form-item label="最低气温" prop="minqw">
          <el-input v-model="form.minqw" placeholder="请输入最低气温" />
        </el-form-item>
        <el-form-item label="相对湿度" prop="sd">
          <el-input v-model="form.sd" placeholder="请输入相对湿度" />
        </el-form-item>
        <el-form-item label="时间" prop="tjDate">
          <el-date-picker clearable
            v-model="form.tjDate"
...
<script>
import { ghyj, getDetail, delDetail, addDetail, updateDetail } from "@/api/system/detail";
